...
<div class="container">
	<div class="card text-white bg-dark" style="margin-top: 1%;">
		<div class="card-header"><h4 class="card-title">Inventario General</h4></div>
		<div class="card-body">
			<table class="table">
				<thead>
					<th>Foto</th>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a href="#" class="btn btn-outline-danger btn-sm" onclick="bootbox.confirm('Seguro que desea realizar esta accion', function(result){ if (result == true){ location.href='eliminar_producto.php?clave=<?php echo $f['clave'] ?>&foto=<?php echo $f['foto'] ?>&pag=general.php';}})"><span class="material-icons">clear</span></a>
						</td>
					</tr>
					<?php 
				}
